      ...
      <div className="max-w-2xl mx-auto p-4 lg:p-6 space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-primary to-accent text-white text-sm font-medium rounded-xl shadow-float"
          >
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {rules.map((rule) => (
              <div
                key={rule.id}
                className="bg-surface/40 backdrop-blur-xl border border-border/20 rounded-xl p-4"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span
                        className={`px-2 py-0.5 text-xs rounded-full ${rule.enabled ? "bg-success/10 text-success" : "bg-muted-foreground/20 text-muted-foreground"}`}
                      >
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {rule.actions.map((action) => (
                        <span
                          key={action}
                          className="flex items-center gap-1 px-2 py-0.5 text-xs rounded-md bg-surface-container text-muted-foreground"
                        >

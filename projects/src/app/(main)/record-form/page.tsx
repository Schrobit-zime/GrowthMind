...
const templates = [
  ...
  { id: "study-checkin", label: "学习打卡", icon: "📚", preselect: ["learning"] },
  {
    ...
    label: "全面记录",
    icon: "📋",
    preselect: ["learning", "work", "life", "health", "mood"],
  },
];
...
export default function RecordFormPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (selectedDimensions.includes("life")) body.life = { notes: lifeText };
      if (selectedDimensions.includes("mood")) body.mood = { score: moodScore };
              ...
              <Button
                ...
                className={`flex flex-col items-center gap-2 p-4 rounded-xl border h-auto ${
                  activeTemplate === tpl.id
                    ...
                    : "backdrop-blur-md bg-white/5 border-white/10 text-muted-foreground hover:text-foreground"
                }`}
              >
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setLearningMastery(Number(e.target.value))}
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setWorkEfficiency(Number(e.target.value))}
                  className="w-full h-2 bg-surface-container rounded-full appearance-none cursor-pointer accent-primary"
                />
              </div>
            </CardContent>
          ...
          <Card className="backdrop-blur-md bg-white/5 border-white/10">
            ...
            <CardContent>
              <Textarea
                ...
                placeholder="记录你的生活点滴：作息、饮食、运动、社交..."
                rows={3}
      ...
      <AlertDialog open={showCancelConfirm} onOpenChange={setShowCancelConfirm}>
        <AlertDialogContent className="backdrop-blur-2xl bg-white/5 border-white/10">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>当前填写的内容将不会被保存</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
